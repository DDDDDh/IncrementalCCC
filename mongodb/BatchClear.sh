...
#文件路径为了方便java调用，这里暂时采用绝对路径
#相对路径：config_file="configs/alicloud_mongodb.conf"

config_file="/Users/yi-huang/Project/IncrementalCCC/mongodb/configs/alicloud_mongodb.conf"
