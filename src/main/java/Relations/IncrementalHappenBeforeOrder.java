...
//            System.out.println("Dealing with read:" + rOp.easyPrint() +"position:" + rOp.getPosition() +" at process " + this.processID + " corresponding write:" + wOp.easyPrint() +"position:" + wOp.getPosition() + "process:" + this.processID);
