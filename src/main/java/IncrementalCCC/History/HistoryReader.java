...
package IncrementalCCC.History;
...
public class HistoryReader {
    ...
    public LinkedList<Operation> readHistory() throws IOException{
        return this.readHistory(100000000);
    }

    public LinkedList<Operation> readHistory(int maxIndex) throws IOException{
        System.out.println("Reading history in " + url);
        System.out.println("Setting maxIndex is " + maxIndex);
