...
//        int k = 1;
            ...
            String stressTestOut = "target/RandomHistories/StressTestLogfile0326_2_Round"+ k +".txt";
            File outfile = new File(stressTestOut);
            PrintWriter logout = new PrintWriter(outfile);
            String originalCheckLog = "target/RandomHistories/StressTestOriginalCheckLog0326_2_Round" + k + ".txt";
            String mongoCheckLog = "target/RandomHistories/StressTestMongoCheckLog0326_2_Round" + k + ".txt";
...
//
                    ...
                    CCProducer ccProducer = new CCProducer(opNum, processNum, 3, 1);
...
//            System.out.println("");
                    ...
                    String mongoLog = "target/RandomHistories/mongoLogfile_0326_2_" + "_opNum" + opNum + "_processNum" + ccProducer.getProcessNum() + ".edn";
...
//                    connector.mongoRun("mongodb://127.0.0.1:27013", "test_mongo", "original_data", url, mongoLog);
                    connector.mongoRun("mongodb://dh:dh@n3.disalg.cn:26011", "test_mongo", "original_data", newPath, mongoLog);
